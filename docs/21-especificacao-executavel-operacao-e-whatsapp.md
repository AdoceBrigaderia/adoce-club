...
12. **Equipe**.
13. **Plano Diretor** e **Restaurar produção**, somente owner.
...
### OP-120 — Plano Diretor — ATUAL

- **Conteúdo:** itens de aceite, evidência, responsável, status e bloqueio.
- **Regra:** checklist não prova funcionamento; cada item aponta para evidência verificável.

### OP-130 — Restauração de produção — ATUAL/RESTRITO
