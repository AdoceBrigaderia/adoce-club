...
describe("funda??o segura do cat?logo Meta", () => {
  it("preserva identificador permanente e fila local", () => {
    expect(migration).toContain("meta_retailer_id text");
    expect(migration).toContain("O identificador permanente da Meta n?o pode ser alterado");
  ...
  it("protege o hist?rico com RLS e acesso apenas gerencial", () => {
  ...
  it("n?o inclui exclus?o destrutiva de produto", () => {
