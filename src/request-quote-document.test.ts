...
describe("orçamento: leitura do que a cliente pediu", () => {
  ...
  it("aceita ponto e vírgula e quebra de linha", () => {
  ...
  it("preserva texto livre quando não há lista", () => {
  ...
  it("não confunde 'e' de palavra com separador", () => {
