...
describe("agenda semanal do Festival de Fatias", () => {
  ...
  it("oferece pedido imediato e solicitação de reserva honesta", () => {
    expect(dialog).toContain("Não precisa esperar o Cantinho da Adoce.");
  ...
  it("mostra separadamente os sabores antecipados de retirada e do Cantinho da Adoce", () => {
    ...
    expect(dialog).toContain('title: "Cantinho da Adoce"');
  ...
  it("distingue um dia somente com retirada do Cantinho da Adoce sem cardápio publicado", () => {
  ...
  it("permite planejar data, modalidade, sabor e quantidade na operação", () => {
    expect(admin).toContain("Cardápio e atendimento");
