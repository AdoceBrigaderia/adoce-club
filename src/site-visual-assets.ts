...
export const SITE_VISUAL_PAGE_LINKS: Record<string, SiteVisualPageLink[]> = {
  ...
  "/site/clube-convite-pedido.webp": [publicPage("Adoce Hoje — após enviar um pedido", "/fatias")],
  "/site/adoce-hoje-retirada-ilustracao.webp": [publicPage("Adoce Hoje", "/fatias")],
  "/site/adoce-hoje-barraquinha-ilustracao.webp": [publicPage("Adoce Hoje", "/fatias")],
  ...
  "/site/hero-cake.webp": [publicPage("Entrar no Clube Adoce", "/clube/entrar")],
  "/adoce-hoje/sabores-hoje.webp": [publicPage("Adoce Hoje", "/fatias")],
};
