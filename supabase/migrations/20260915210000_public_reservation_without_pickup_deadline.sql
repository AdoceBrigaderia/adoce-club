...
declare
  ...
  batch_deadline time := time '23:59:59';
begin
  ...
  -- Compatibilidade: navegadores antigos podem enviar horario oculto.
  -- O horario nao condiciona reserva; disponibilidade e informativa.
