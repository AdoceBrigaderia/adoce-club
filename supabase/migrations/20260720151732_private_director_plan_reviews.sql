-- Respostas privadas do Plano Diretor. Somente proprietÃ¡rios ativos da Adoce.
...
comment on table public.project_decision_reviews is
  'Respostas privadas de Rubens e Beth para validaÃ§Ã£o do Plano Diretor da operaÃ§Ã£o de vendas.';
