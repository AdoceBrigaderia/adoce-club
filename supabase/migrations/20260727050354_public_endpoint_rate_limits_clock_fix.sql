...
-- Homologação recebeu a primeira versão antes da correção do identificador
-- `current_time`, que conflitia com a palavra reservada do PostgreSQL. Esta
-- migration mantém o histórico reproduzível e reaplica a função corrigida.
